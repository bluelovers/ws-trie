...
function Trie(input) {
    ...
    const trie = create_1.default([...input]);
    return {
        /**
         ...
         */
        dump(spacer = 0) {
            return utils_1.default.stringify(trie, spacer);
        },
        /**
        ...
        removeWord(word) {
            ...
            const { prefixFound, prefixNode } = checkPrefix_1.default(trie, word);
            if (prefixFound) {
        ...
        isPrefix(prefix) {
            ...
            const { prefixFound } = checkPrefix_1.default(trie, prefix);
            return prefixFound;
        },
        /**
        ...
        getPrefix(strPrefix, sorted = true) {
            ...
            const { prefixNode } = checkPrefix_1.default(trie, strPrefix);
        ...
        getWords(sorted = true) {
            ...
            return recursePrefix_1.default(trie, '', sorted);
        },
        /**
        ...
        getAnagrams(letters) {
            ...
            return permutations_1.default(letters, trie, {
                type: 'anagram',
            });
        },
        /**
